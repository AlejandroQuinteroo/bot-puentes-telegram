...
async def enviar_resumen_directo(context, chat_id):
    try:
        ...
        hoy = datetime.now()
        encabezado = "📋 *Resumen de pruebas de resistencia pendientes:*\n\n"
        ...
        for _, row in df.iterrows():
            ...
            linea = (
                ...
                f"⏱ Pendientes: {', '.join(recomendaciones)}\n\n"
            )
